 ...
 * 
 * @author tyn
 * @date 2015年5月14日上午10:04:46
 * @version 1.7
 */
public class TranslucentBitmapDisplayer extends RoundedBitmapDisplayer {

	public TranslucentBitmapDisplayer(int cornerRadiusPixels, int marginPixels) {
